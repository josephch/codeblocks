...
void cbProject::CalculateCommonTopLevelPath()
{
    ...
    Manager::Get()->GetLogManager()->DebugLog("Project's common toplevel path: " + m_CommonTopLevelPath + " basePath : " + basePath + " commonTopLevelChildOfBase: " + (commonTopLevelChildOfBase ? "true" : "false"));
